...
def process_video(video_to_process):
  ...
  with mp_holistic.Holistic(
    ...
    min_tracking_confidence=mintrack, model_complexity=2, refine_face_landmarks = True) as holistic:
    ...
    while(cap.isOpened()):
      ...
      if ret==True:
        ...
        # if i==1:
        #   print(holistic_landmarker_result.pose_landmarks.landmark)
        #   i+=1
        ...
        j = 1 #iterate through points of landmark
