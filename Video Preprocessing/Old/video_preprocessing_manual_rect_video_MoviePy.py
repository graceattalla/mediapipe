'''
Rotate a video based on a selected angle so that all videos have Box and Blocks container straight.

Using MoviePy which might work faster than OpenCV. Rotation is implement but not cropping (cropping variables are set though)
