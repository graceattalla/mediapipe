'''
Using the variables from video_preprocessing_manual_rect_video_OpenCV_variables_csv.py, rotate and zoom each video and save.

The accounts for camera angle rotation differing across each video recorded.

Note: The zooming function of this file is unnecessary as daat will be normalized to each participant afterwards.
video_preprocessing_manual_rect_video_OpenCV_rotate_only was used in preprocessing.
