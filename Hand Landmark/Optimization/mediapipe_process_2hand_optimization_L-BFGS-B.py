'''
Use L-BFGS-B to optimize MediaPipe hyperparameters for a given video.

Minimization function is number of rows with a landmark detection present.
...
#Minimization function- number of rows with a detected landmark present
def num_rows(param):
...
result = minimize(num_rows, initial_guess, method='L-BFGS-B', bounds=bnds) #need to pass in param??
