'''
Process a folder of videos with MediaPipe Hand Landmark model. Save the outputs to a csv and skeleton video.
...
#The save path to the model downloaded from MediaPipe
model_path = r'C:\Users\grace\OneDrive\Surface Laptop Desktop\BCI4Kids\Github\mediapipe\Hand Landmark\hand_landmarker.task'

#Process video with Hand Landmarker Model
...
#Create skeleton of video with outputted landmarks
